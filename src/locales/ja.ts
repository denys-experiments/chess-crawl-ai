...
export const ja: Locale = {
  ...
  nameParts: {
    firstNames: [
        'アキラ', 'ボビー', 'ケイ', 'リュウ', 'エイジ', 'フミ', 'グレイ', 'ハル',
        'ジェイミー', 'ジョウジ', 'カイ', 'レツ', 'モリ', 'パット', 'クイン', 'リョウ',
        'ロアン', 'サム', 'タイキ', 'ビクター', 'アッシュ', 'ブレア', 'カモン', 'ダイキ',
        'エミ', 'フィン', 'ハヤト', 'アイ', 'ジェシー', 'ケンジ', 'ローガン',
        'マロ', 'ノエル', 'パーカー', 'レイガン', 'ソウヤ', 'スカイ', 'タツ', 'フユ'
    ],
    lastNames: [
        '勇猛', '大胆', '迅速', '賢明', '強力',
        '不動', 'の賢者', '公正', '不屈', '温和',
