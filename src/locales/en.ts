...
export const en = {
  ...
  history: {
    ...
    playerCapture: "Your {name} ({piece}) captures a {faction}'s {targetPiece} at ({x}, {y}).",
    ...
    playerMove: "Your {name} ({piece}) moves to ({x}, {y}).",
    enemyMove: "A {faction}'s {name} ({piece}) moves to ({x}, {y}).",
    enemyCapture: "A {faction}'s {name} ({piece}) captures another {targetFaction}'s {targetPiece} at ({x}, {y}).",
    enemyNoMoves: "The {faction} faction has no available moves.",
    levelStart: "--- Starting Level {level} ---",
    pieceCarriedOver: "Your {name} ({piece}) was carried over from the previous level.",
    playerPieceCaptured: "Your {name} ({piece}), found on level {discoveredOnLevel} with {captures} captures, was defeated by a {faction}'s {enemyPiece}.",
    playerPieceCaptured_cosmetic: "Your {name} ({piece}), found on level {discoveredOnLevel} with {captures} captures and wearing {cosmetic}, was defeated by a {faction}'s {enemyPiece}.",
  },
  hud: {
    title: "Chess Crawl",
    level: "Level {level}",
